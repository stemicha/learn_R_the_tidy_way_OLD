...
The `sqrt()` function takes about 600 ns, or 0.6 µs, to compute the square root of 100 numbers. That means if you repeated the operation a million times, it would take 0.6 s. So changing the way you compute the square root is unlikely to significantly affect real code.
